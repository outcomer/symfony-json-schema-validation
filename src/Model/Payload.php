...
/**
 * Container for validated HTTP request data (body, query, path)
 */
final class Payload
{
	/**
	 ...
	 */
	public function __construct(private object|array|null $body, private object $query, private object $path)
	{
	}
